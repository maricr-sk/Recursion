/**
 * @author Marissa Crevecoeur; UNI: mac2538
...
public class Recursion {
    ...
    private static boolean memberHelper(int key, int[] array, int index) {
        // TODO
        if(array.length==0 || index >= array.length) return false;
        if(array.length== 1 && array[index] != key) return false;
...
/******************************************************************************/
    ...
    public static String separateIdentical(String s) {
        ...
        return s.substring(0,i) + separateIdentical(s.substring(i));
    }
